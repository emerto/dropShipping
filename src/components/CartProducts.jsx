    ...
    <div className="w-full max-w-xs h-full max-h-xs bg-gray-900 border border-white">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800 border border-blue-200">
